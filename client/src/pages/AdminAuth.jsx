      ...
      <div className="w-full max-w-md">
        <div className="card p-8">
          <div className="mb-6 text-center">
            ...
            <h1 className="mt-3 text-xl font-bold text-ink-900">Admin portal</h1>
            <p className="mt-1 text-sm text-ink-500">Restricted access — administrators only.</p>
          </div>
          ...
          <form onSubmit={submit} className="space-y-4">
            <div>
              ...
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required className="input" placeholder="admin@city.gov" />
            </div>
            <div>
        ...
        <p className="mt-4 text-center text-xs text-ink-400">
          Citizens sign in <Link to="/citizen/login" className="text-brand-600 hover:underline">here</Link>. Administrator accounts are provisioned by the platform.
        </p>
      </div>
    </div>
  );
